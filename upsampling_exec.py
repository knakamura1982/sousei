...
if __name__ == '__main__':
    ...
    # 処理の実行
    img = np.asarray([load_single_image(in_filepath, size=in_size, mode=1)]) # 入力画像をにリサイズして読み込む
    show_image(img[0], mode=1) # 入力画像を表示
    ...
    # 結果を保存
    show_image(y_cpu[0], mode=1) # アップサンプリング結果を表示
